...
class BamlSyncClient:
    ...
    def PredictPerturbEffect(self, pert: str,gene: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="PredictPerturbEffect", args={
                "pert": pert,"gene": gene,
            })
...
class BamlStreamClient:
    ...
    def PredictPerturbEffect(self, pert: str,gene: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[types.PerturbEffect, types.PerturbEffect]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="PredictPerturbEffect", args={
            "pert": pert,"gene": gene,
        })
        return baml_py.BamlSyncStream[types.PerturbEffect, types.PerturbEffect](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def PredictPerturbEffect(self, pert: str,gene: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="PredictPerturbEffect", args={
            "pert": pert,"gene": gene,
        }, mode="request")
        return __result__
