...
class LlmResponseParser:
    ...
    def PredictPerturbEffect(
        self, llm_response: str, baml_options: BamlCallOptions = {},
    ) -> types.PerturbEffect:
        __result__ = self.__options.merge_options(baml_options).parse_response(function_name="PredictPerturbEffect", llm_response=llm_response, mode="request")
        return typing.cast(types.PerturbEffect, __result__)
...
class LlmStreamParser:
    ...
    def PredictPerturbEffect(
        ...
        __result__ = self.__options.merge_options(baml_options).parse_response(function_name="PredictPerturbEffect", llm_response=llm_response, mode="stream")
        return typing.cast(types.PerturbEffect, __result__)
